...
namespace Xutim\EventBundle\DependencyInjection;
 ...
 */
final class XutimEventExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
    public function load(array $config, ContainerBuilder $container): void
    {
        ...
        foreach ($configs['models'] as $alias => $modelConfig) {
            $container->setParameter(sprintf('xutim_event.model.%s.class', $alias), $modelConfig['class']);
        }
    ...
    public function prepend(ContainerBuilder $container): void
    {
        $container->prependExtensionConfig('doctrine_migrations', [
            'migrations_paths' => [
                'Xutim\EventBundle\Migrations' => __DIR__ . '/../Migrations',
            ]
        ]);
        ...
        foreach ($config['models'] as $alias => $modelConfig) {
            ...
            $interface = sprintf('Xutim\\EventBundle\\Domain\\Model\\%sInterface', $camel);
